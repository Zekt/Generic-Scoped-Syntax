...
The interpretation function \verb|⟦_⟧|, \verb|Semantics|, and generic programs like \verb|Ren| (fig..) will be redefined in this section and have different types from their counterparts in \cref{sec:recap}, despite playing similar roles.
