...
\newcommand{\codefigure}{\normalsize\setlength{\mathindent}{0em}\setlength{\abovedisplayskip}{0ex}\setlength{\belowdisplayskip}{0ex}\noindent}
...
\AgdaBound{τ}\AgdaSymbol{))}\<%
\end{code}
The point here is that descriptions are data, from which we can compute types and functions for the described syntaxes.
